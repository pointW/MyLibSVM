...
public class Item {
	...
	public Item(String act, String position, Double t_iqr, Double t_mad, Double t_max, Double t_mcr, Double t_mean,
				Double t_min, Double t_rms, Double t_sttdev, Double t_variance) {
